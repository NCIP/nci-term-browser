...
<div class="footer" style="width:720px">
  <ul>
    ...
    <li><a href="http://www.cancer.gov/policies/page4" target="_blank" alt="National Cancer Institute Accessibility">Accessibility</a> |</li>
    <li><a href="http://www.cancer.gov/policies/page7" target="_blank" alt="National Cancer Institute FOIA">FOIA</a></li>
  </ul>
  <p>
