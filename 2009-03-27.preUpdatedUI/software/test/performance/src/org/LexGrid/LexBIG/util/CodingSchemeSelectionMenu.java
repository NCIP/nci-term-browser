...
/**
 * Helper class used to display a list of available code systems and
 * return the user selection.
 *
 */
public class CodingSchemeSelectionMenu implements Constants {
	 ...
	 * @return A coding scheme summary correponding to the user selection; null if
	 * no selection is made or an error occurs.
	 */
			...
			if (choices.size() > 0) {
				...
				try {
					...
					if (prompt) {
    					...
    					Util.displayMessage("FYI: Automatically selected: " + i);
                        Util.displayMessage("");
