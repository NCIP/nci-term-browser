...
import org.lexevs.tree.evstree.*;
...
System.out.println("walkTreeFromRoot: " + node.getCode() + " " + node.getEntityDescription());
...
if (!hset.contains(child_code)) {
    hset.add(child_code);
					...
					System.out.println(child.getCode() + " " + child.getEntityDescription());
