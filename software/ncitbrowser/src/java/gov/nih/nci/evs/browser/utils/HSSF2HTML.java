...
public class HSSF2HTML {
     ...
     */
    public HSSF2HTML(final String filename, int sheet, int startIndex, int endIndex) throws IOException {
    ...
    public HSSF2HTML(final InputStream in) throws IOException {
        sdf = new SimpleDateFormat("dd/MM/yyyy");
        if (in == null) {
            book = null;
            palette = null;
    ...
    public HSSF2HTML(final String filename, int sheet, int startIndex, int endIndex, String url) throws IOException {
		InputStream in = getInputStream(filename);
        sdf = new SimpleDateFormat("dd/MM/yyyy");
        if (in == null) {
            book = null;
    ...
    public HSSF2HTML(final InputStream in, String url) throws IOException {
        sdf = new SimpleDateFormat("dd/MM/yyyy");
        if (in == null) {
            book = null;
            palette = null;
    ...
    */
	...
	public static void main(String [ ] args)
	{
		...
		try {
        	System.out.println(new HSSF2HTML(new FileInputStream(new File(filename))).getHTML());
    	} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
